...
该应用程序使用 `易语言` 编写，部分反病毒软件可能会报告用户应用程序可能危害此电脑，请**忽略这一类提示并信任应用程序**

除了应用程序内提供的功能，应用程序**不会额外向 `Windows` 注册表写入不必要的数据**，**仅会在应用程序下的运行目录生成一个“config.ini”配置文件**

应用程序内通过的部分功能可能需要向用户申请管理员权限
